<div>
    <div class="d-grid gap-5">
        ...
        <a href="{{ route('classroom.show', [$course->slug, $course->levels()->first()->title, $course->levels()->first()->topics()->first()]) }}" class="card bg-hover-secondary text-hover-inverse-secondary">
