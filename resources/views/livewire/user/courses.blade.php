...
<div class="rounded bg-white border p-10">
    <div class="text-center">
        <h3 class="text-gray-900">You haven't enrolled into any course yet</h3>
    </div>
</div>
@endforelse
...
<div class="rounded text-center bg-light border border-secondary border-dashed d-grid d-flex flex-column p-5">
    <div class="h3 d-block my-2">Want to enroll into more courses?</div>
    <br>
...
<fieldset class="row gap-2 mt-5 px-auto">
    <legend>Check Our New Courses Below <i class="bi bi-chevron-down fs-3"></i>
    </legend>
